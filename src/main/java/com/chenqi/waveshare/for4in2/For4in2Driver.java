...
public class For4in2Driver {

    public final static int WIDTH = 400;
    public final static int HEIGHT = 300;

    private For4in2Driver(){}

    private static For4in2Driver for4In2Driver = new For4in2Driver();

    public static For4in2Driver getInstance(){
        return for4In2Driver;
    }
